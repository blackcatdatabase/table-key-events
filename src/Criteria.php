 ...
 * - whitelist LIKE:   [ 'basename', 'event_type', 'note', 'source' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'key_id', 'basename', 'event_type', 'actor_id', 'job_id', 'note', 'meta', 'source', 'created_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'key_id', 'basename', 'event_type', 'actor_id', 'job_id', 'note', 'meta', 'source', 'created_at' ], true);
            $parts = [];
