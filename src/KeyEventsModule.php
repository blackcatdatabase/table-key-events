...
final class KeyEventsModule implements ModuleInterface
{
    public function name(): string { return 'table-key_events'; }
    public function table(): string { return 'key_events'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-crypto_keys', 'table-users' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_key_events_actor', 'fk_key_events_key' ];
