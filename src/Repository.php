...
use BlackCat\Database\Packages\KeyEvents\Repository\KeyEventRepositoryInterface;
use BlackCat\Database\Packages\KeyEvents\Repository\KeyEventRepository as GeneratedRepository;
...
{
  private KeyEventRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof KeyEventRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected KeyEventRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyEvents\Dto\KeyEventDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyEvents\Dto\KeyEventDto|null { return $this->repo->getById($id, $asDto); }
