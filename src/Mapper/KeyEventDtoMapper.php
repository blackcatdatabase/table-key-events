...
namespace BlackCat\Database\Packages\KeyEvents\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO KeyEventDto:
 ...
 */
final class KeyEventDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'key_id' => 'keyId', 'basename' => 'basename', 'event_type' => 'eventType', 'actor_id' => 'actorId', 'job_id' => 'jobId', 'note' => 'note', 'meta' => 'meta', 'source' => 'source', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'key_id', 'actor_id', 'job_id' ];
    /** @var string[] */
     ...
     * @return KeyEventDto
     */
    public static function fromRow(array $row): KeyEventDto
    {
        /** @var KeyEventDto */
    ...
    public static function fromRowOrNull(?array $row): ?KeyEventDto
    {
     ...
     *
     * @param KeyEventDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(KeyEventDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KeyEventDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KeyEventDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KeyEventDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KeyEventDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KeyEventDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KeyEventDto>
     */
