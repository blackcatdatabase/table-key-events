...
- Pkg folder: [packages\key-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\key-events)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-events -Apply
