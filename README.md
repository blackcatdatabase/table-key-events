...
| Pkg folder | [packages/key-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/key-events) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-events -Apply
